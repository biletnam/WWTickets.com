    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="alphabet">                                    
                        <li<? echo ($URI[2] == 'all') ? ' class="this-letter"' : ''; ?>><a href="/customers/sioux_city.php"><? echo ($URI[2] == 'all') ? '<strong>All</strong>' : 'All'; ?></a></li>
                        <?
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        if($term=="") 
                                        {
                                            ...
                                            // $cust_request = ("SELECT * FROM customerInfo WHERE custLName LIKE '{$term}%' OR custComp LIKE '{$term}%' ORDER BY custLName ASC");
                                            $cust_request = ("SELECT * FROM customerInfo WHERE storeID = '112' AND (custLName LIKE '{$term}%' OR custComp LIKE '{$term}%') ORDER BY custLName ASC, custComp ASC");
                                        }
