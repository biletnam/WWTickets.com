                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="referralType" >
                                        ...
                                        <?
                                            $market_request = ("SELECT * FROM Vendors LEFT JOIN VendorAds ON VendorAds.adVendorID = Vendors.vendorID ORDER BY Vendors.vendorName ASC");
                                            ...
                                            while ($market_row = mysql_fetch_array($market_result)) { 
                                                extract($market_row);
                                                $marketName = $vendorName.' - '.$adName;
                                                echo '<option value="'.$vendorName.' - '.$adName.'"'.($marketName == $marketType ? ' selected="selected"' : '').'>'.$adName.'</option>'."\r";
                                            }
                                        ?>
                                    </select>
                                </div> 
