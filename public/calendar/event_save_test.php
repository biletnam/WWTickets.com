...
$NoteStart = date("D, F n",strtotime($start_date)); if ($NoteStart == '12/31/1969') {$NoteStart = ''; }
$NoteEnd = date("D, F n",strtotime($end_date)); if ($NoteEnd == '12/31/1969') {$NoteEnd = ''; }


$NoteStart = $NoteStart.", ".$start_time;
$NoteEnd = $NoteEnd.", ".$end_time;
...
$descriptionCalendar = "<strong>Date & Time: </strong>".$NoteStart." - ".$NoteEnd."<br/><br/><strong>Where: </strong>".$address." ".$city.", ".$state."<br/><br/><strong>Customer Referral: </strong>".$customerReferral."<br/><br/><strong>Description: </strong>".$EntryNote." - ".$initials;
