...
include_once("$root/lc.php");
		...
		while ($cust_row = mysql_fetch_array($cust_result)) { 
            ...
            $viewuserLevel = $cust_row['userLevel'];
            $viewuserAssignType = $cust_row['userAssignType'];
            $viewuserLocation = $cust_row['userLocation'];
		}
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="/users/form/mod.php">
                            	<input type="hidden" name="type" value="edit" />
								<?php include $root.'/users/form/fields.php'; ?>
                            </form>
                        </div>
                        <!-- /.panel-body -->
                    </div>
