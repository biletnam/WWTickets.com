		...
		if(isset($_GET['action']))
		{
			...
			switch($_GET['action'])
			{
				...
				case "insert":
					...
					$extra = array('repeat_method' => (isset($_GET['repeat_method']) ? $_GET['repeat_method'] : 'no'), 'repeat_times' => (isset($_GET['repeat_times']) ? $_GET['repeat_times'] : 1)isset($_GET['sub_title']) ? $_GET['sub_title'] : 'no'),);
