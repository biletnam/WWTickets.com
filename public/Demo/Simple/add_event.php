...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">New Calendar Entrys</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body"> 
                            ...
                            <form method="post" action="/Demo/Simple/event_save.php">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <?
                                            ...
                                            while ($calUsers_row = mysql_fetch_array($calUsers_result)) { 
                                                ...
                                                ?>
                                                <option value="<?php echo $calUserID ?>"><?php echo $firstName; ?> <?php echo $lastName; ?></option>
                                            <? } ?>
                                        </select>
