   ...
   <!-- Calendar Modal -->
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a href="edit_event.php?id=<?php echo $c;?>" class="btn btn-info">Edit <?php echo $c; ?></a>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                  	<p style="margin-top:30px;"> <a href="add_event.php" class="btn btn-success pull-right" style="margin-right: 10px;">New Entry</a> </p>
