...
$starDate = date("m/j/Y",strtotime($startDate)); if ($startDate == '12/31/1969') {$starDate = ''; }
$enDate = date("m/j/Y",strtotime($endDate)); if ($endDate == '12/31/1969') {$enDate = ''; }
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">"<?php echo $starDate; ?> - <?php echo $enDate; ?>" Tickets</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="panel-body">
                                <div class="dataTable_wrapper">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            <?php 
                                                $cust_request = ("SELECT * FROM customerTickets LEFT JOIN customerInfo ON customerTickets.ticketCustID=customerInfo.custID WHERE ticketStatus != 'Gift Sent' AND customerTickets.ticketDate BETWEEN '$startDate' AND '$endDate'  ORDER BY ticketID DESC");
