...
include_once("$root/lc.php");
		...
		$installer_request = ("SELECT * FROM ticketInstallers WHERE installerID= '".$_GET['installerID']."'");
		$installer_result = mysql_query ($installer_request,$db) or die ("Query failed: $installer_request");
		$installer_total = mysql_num_rows($installer_result);
		if($installer_total == 0) echo "<p>That time doesn't exist.</p>\n";
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Installer</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="/tickets/installers/form/mod.php">
                            	<input type="hidden" name="type" value="edit" />
								<?php include $root.'/tickets/installers/form/fields.php'; ?>
                            </form>
                        </div>
                        <!-- /.panel-body -->
                    </div>
