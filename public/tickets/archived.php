...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> Gift Sent Tickets</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $cust_request = ("SELECT * FROM customerTickets WHERE ticketStatus = 'Gift Sent' ORDER BY ticketDate DESC");
                ...
                <p> <a href="/tickets/"> <button class="btn btn-success" style="margin-top:-7px;margin-left:15px;" type="button">Processing Tickets</button> </a>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
        </div>
