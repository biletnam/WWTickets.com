...
// update database with new info
	...
	if ($type == 'new') {
		...
		$sql_query = "INSERT INTO ticketTask (taskticketID,taskEmp, taskNotes, taskDate, taskStatus, createdBy, ticketRedFlag,completeBy) ";
		$sql_query .= "VALUES ('$ticketID', '$taskEmp', '$taskNotes','$taskDate', '$taskStatus', '$createdBy', '$ticketRedFlag','$completeBy');";
