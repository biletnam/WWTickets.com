...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tickets <span class="fa fa-angle-right"></span> Siding</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
 <?php $jobProduct = 'Siding'; ?>
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $cust_request = ("SELECT * FROM customerTickets LEFT JOIN customerInfo ON customerTickets.ticketCustID=customerInfo.custID WHERE ticketStatus != 'Gift Sent' AND jobProduct = 'Siding' ORDER BY ticketID DESC");
