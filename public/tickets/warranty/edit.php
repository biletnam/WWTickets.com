...
include_once("$root/lc.php");
    ...
    $custID = $_GET['custID'];
        ...
        $warranty_request = ("SELECT * FROM warrantyTransfer WHERE ticketID = '".$_GET['ticketID']."' AND custID = '".$_GET['custID']."'");
        $warranty_result = mysql_query ($warranty_request,$db) or die ("Query failed: $warranty_request");
        $warranty_total = mysql_num_rows($warranty_result);
        if($warranty_total == 0) echo "<p>That ticket doesn't exist.</p>\n";
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Transfer Warranty</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4><span>Warranty Details</span></h4>
                        </div>
                        <div class="panel-body">
                            <form role="form" method="post" action="/tickets/warranty/form/detail-mod.php">
                                <input type="hidden" name="type" value="edit" />
                            	<input type="hidden" name="warrantyID" value="<?php echo $warrantyID; ?>" />
								<?php include $root.'/tickets/warranty/form/detail-fields.php'; ?>
                            </form>
                        </div>
                        <!-- /.panel-body -->
                    </div>
