...
include_once("$root/lc.php");
		...
		if($sin_total == 0) echo "<p>That Product doesn't exist.</p>\n";
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Sin Bin</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="/sin-bin/form/mod.php">
                            	<input type="hidden" name="type" value="edit" />
								<?php include $root.'/sin-bin/form/fields.php'; ?>
                            </form>
                        </div>
                        <!-- /.panel-body -->
                    </div>
